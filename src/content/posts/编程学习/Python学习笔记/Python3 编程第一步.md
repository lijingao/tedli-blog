...
- [ ] **1. Hello World**
  ...
  - 打印 "Hello, Python!" ---知识点：print("内容")
  - 打印你的名字 ---知识点：print("我的名字是：xxx")
...
- [ ] **2. 变量与数学运算**
  ...
  - 定义变量 `a = 10`、`b = 3` ---知识点：a = 值
  - 计算并打印加法、减法、乘法、除法结果 ---知识点：print(a + b)
...
- [ ] **3. 列表操作**
  ...
  - 创建列表 `colors = ["红", "绿", "蓝"]` ---知识点：colors = ["元素1", "元素2"]
  - 打印第一个元素和最后一个元素 ---知识点：colors[0]、colors[-1]
  - 打印列表长度 ---知识点：len(colors)
...
- [ ] **4. for 循环**
  ...
  - 用 for 循环打印 1 到 5 ---知识点：for i in range(1, 6):
  - 每个数字后面加空格 ---知识点：print(i, end=" ")
...
- [ ] **5. if 条件语句**
  ...
  - 输入一个数字 `num` ---知识点：num = int(input("提示语"))
  - 如果是偶数，打印"偶数" ---知识点：if num % 2 == 0:
  - 如果是奇数，打印"奇数" ---知识点：else:
...
- [ ] **6. while 循环**
  ...
  - 用 while 循环累加 1 到 100 ---知识点：while i <= 100:
  - 打印总和 ---知识点：print(total)
...
- [ ] **7. end 关键字**
  ...
  - 用 for 循环打印 1 到 5，用逗号分隔在同一行 ---知识点：print(i, end=",")
  - 最后打印一个换行 ---知识点：print()
